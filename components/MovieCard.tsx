...
import { Movie, dbMovie } from "@/typings";
import Image from "next/image";

function MovieCard({ movie }: { movie: Movie | any}) {
  return (
    <div className="flex-shrink-0 relative cursor-pointer transform hover:scale-105 transition duration-200 ease-out hover:drop-shadow-lg">
      ...
      <Image
        className="w-fit lg:min-w-[200px] h-56 object-cover object-center shadow-md shadow-gray-900 drop-shadow-xl rounded-sm"
